...
export class DeltaGreenUI {
  ...
  static showLoginAnimation() {
    ...
    bgImage.src = 'modules/deltagreen-ui/asset/img/BG-sony.png';
    
    // Précharger le logo
    const logoImage = new Image();
    logoImage.src = 'modules/deltagreen-ui/asset/img/DG_logo.png';
    ...
    $loginAnimation.css({
      ...
      'z-index': '4', // En dessous de l'image BG-sony.png (z-index: 5)
